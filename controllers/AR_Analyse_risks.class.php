...
/*=================================================selects======================================================*/
		...
		static function select_ar_analyze_risks_by_id_risk($id_risk){
		...
		static function select_analyse_risk_by_project_by_magnitude(){
			...
			$n1 = self::getConn()->prepare('SELECT * FROM ar_analyze_risks ar, ir_risks ir WHERE ar.id_risk = ir.id and ir.deleted = 0 and ar.id_project="'.$_SESSION['project_id'].'" ORDER BY  ar.magnitude_of_risk*1 DESC');
			$n1->execute(array());			 
			$d['dados'] = $n1->fetchAll();	
			$d['num'] = $n1->rowCount();
			return $d;			
		...
		static function select_analyse_risk_by_project_by_fr(){
			...
			$n1 = self::getConn()->prepare('SELECT * FROM ar_analyze_risks ar, ir_risks ir WHERE ar.id_risk = ir.id and ir.deleted = 0 and ar.id_project="'.$_SESSION['project_id'].'" ORDER BY ar.Expected_Scores_FR*1 DESC');
			$n1->execute(array());			 
			$d['dados'] = $n1->fetchAll();	
			$d['num'] = $n1->rowCount();
			return $d;			
		...
		static function select_analyse_risk_by_project_by_le(){
			...
			$n1 = self::getConn()->prepare('SELECT * FROM ar_analyze_risks ar, ir_risks ir WHERE ar.id_risk = ir.id and ir.deleted = 0 and ar.id_project="'.$_SESSION['project_id'].'" ORDER BY ar.Expected_Scores_LE*1 DESC');
			$n1->execute(array());			 
			$d['dados'] = $n1->fetchAll();	
			$d['num'] = $n1->rowCount();
			return $d;			
