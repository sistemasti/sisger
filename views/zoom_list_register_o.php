...
<br>
      ...
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-10">
            <h1><?php echo $_SESSION[$_SESSION['lang']]['Zoom list register']; ?> (<?php echo $_SESSION[$_SESSION['lang']]['Analyze option']; ?>)</h1>
          </div>
          <div class="col-sm-2">
			...
			<br>-->
			<a href="zoom_list?type=1&risk_id=<?php echo $_GET['risk_id']; ?>&option_id=<?php echo $_GET['option_id']; ?>"><button type="button" class="btn btn-block btn-outline-success btn-xs"><?php echo $_SESSION[$_SESSION['lang']]['Return']; ?></button></a>
          </div>
        </div>
      </div><!-- /.container-fluid -->
    </section>
							  ...
							  $.ajax({
								...
								success: function(data) {
									...
									window.scrollTo(0, 0);
											...
											alert(<?php echo "'".$_SESSION[$_SESSION['lang']]['Register save successful']."'"; ?>);
