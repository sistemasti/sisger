...
<br>
      ...
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-10">
            <h1><?php echo $_SESSION[$_SESSION['lang']]['Edit Risk option']; ?></h1>
          </div>
          <div class="col-sm-2">
          ...
          <div class="col-md-12">
            <div class="card">
			  ...
			  <div class="row">
								...
								$txterr 	= '';
								$i 			= Analyze_options::select_options_id($_REQUEST['id']);
								...
								if ( isset($_POST['cadastrar']) ){
									...
									if ( $txterr == "" ){
										...
										Analyze_options::update_options($option,$_REQUEST['id']);
										
										echo '<script language= "JavaScript">alert("'.$_SESSION[$_SESSION['lang']]['Registration successful'].'.");location.href="tr_risk_option"</script>';
              ...
              <div class="col-sm-4 col-md-6">
			   <form name="frmDocuments" method="post" action="tr_risk_options_edit"  enctype="multipart/form-data">
			  ...
			  <div class="col-sm-4 col-md-6">
               <div class="callout callout-info">
                  <h5><?php echo $_SESSION[$_SESSION['lang']]['Risk option']; ?></h5>
