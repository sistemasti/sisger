      ...
      <div class="container-fluid">
        <div class="row mb-2">
          ...
          <div class="col-sm-2">
			...
			<br>-->
			<a href="project_report"><button type="button" class="btn btn-block btn-outline-success btn-xs"><?php echo $_SESSION[$_SESSION['lang']]['Report']; ?></button></a>
          </div>
        </div>
      </div><!-- /.container-fluid -->
    </section>
          ...
          <div class="col-md-12">
            <div class="card">
			  ...
			  <div class="row">
								...
								if ( isset($_POST['cadastrar']) ){
									...
									if ( $txterr == "" ){
										...
										$i = Projects::insert_project($institutions_id,$project,$note,$time_horizon);
			  ...
			  <input type="hidden" name="cadastrar" id="cadastrar" value="1">
				  ...
				  <div class="form-group">
                    <label for="Name"><?php echo $_SESSION[$_SESSION['lang']]['Time horizon in year for this project']; ?></label>
