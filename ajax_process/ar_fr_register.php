...
include("../controllers/AR_Analyse_risks.class.php");
	...
	if($i['num'] > 0){
		AR_Analyse_risks::update_analyse_risk($_POST['type_risk'],$_POST['fdLow'],$_POST['fdProbable'],$_POST['fdHigh'],$_POST['fdUncert'],$_POST['explain'],$_POST['ley'],$_POST['abey'],$_POST['hey'],$_REQUEST['id_risk']);
	}else{
