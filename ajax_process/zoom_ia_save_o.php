...
echo  "</pre>"; */
	...
	if($i['num'] > 0){
		...
		Analyze_options::update_zoom_ia_save($_POST['ia_zoom_link_o'], $_POST['ia_zoom_obs_o'], $_POST['ia_zoom_explanation_fields_o'], $_POST['ia_zoom_notes_explanation_o'], $_POST['ia_zoom_document_name_o'], $_POST['ia_zoom_comment_o'], $_POST['ia_zoom_document_file_o'], $_REQUEST['id_risk'], $_REQUEST['id_option']);
		
	}else{
		
		Analyze_options::insert_zoom_ia_save($_POST['ia_zoom_link_o'], $_POST['ia_zoom_obs_o'],$_POST['ia_zoom_explanation_fields_o'], $_POST['ia_zoom_notes_explanation_o'], $_POST['ia_zoom_document_name_o'], $_POST['ia_zoom_comment_o'], $_POST['ia_zoom_document_fiia_o'], $_REQUEST['id_risk'], $_REQUEST['id_option']);
