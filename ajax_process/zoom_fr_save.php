...
echo  "</pre>"; */
	...
	Build_value_pie::update_zoom_fr_save($_POST['fr_zoom_link'], $_POST['fr_zoom_obs'], $_POST['fr_zoom_explanation_fields'], $_POST['fr_zoom_notes_explanation'], $_POST['fr_zoom_document_name'], $_POST['fr_zoom_comment'], $_POST['fr_zoom_document_file'], $_GET['id']);
